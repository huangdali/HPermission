...
public class HPermissions {
  ...
  private static final String TAG = HPermissions.class.getSimpleName();
  ...
  private static HPermissions mInstance = null;

  public static HPermissions getInstance() {
    if (mInstance == null) {
      mInstance = new HPermissions();
    }
    return mInstance;
  }

  private HPermissions() {
  ...
  /**
   * This method notifies the HPermissions that the permissions have change. If you are making
